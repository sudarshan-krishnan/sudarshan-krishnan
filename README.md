...
<table>
  <tr>
    ...
    <td>
      ...
      • Optimized model performance via quantization & latency reduction<br/>
      • Analyzed <strong>200K+ forklift error logs</strong> for failure pattern detection<br/>
      • Developed Bayesian models estimating repair costs & durations
    </td>
  </tr>
  <tr>
    <td align="center">✈️</td>
    <td><strong>BAE Systems</strong><br/><sub>Student Intern (Co-Op) · <em>Aug 2024–Jun 2025</em></sub></td>
    <td>
      • ML demand forecasting across <strong>74 outstations, 16 hubs</strong><br/>
      • Engineered <strong>40+ features</strong> — achieved <strong>R² = 0.928</strong><br/>
      • Presented predictive supply chain insights to BAE executives<br/>
      • Built inventory optimization & planning dashboards
    </td>
  </tr>
  <tr>
    <td align="center">🏥</td>
    <td><strong>Medical Informatics Engineering</strong><br/><sub>Developer Intern (Co-Op + Summer) · <em>Sep 2023–Apr 2025 · Fort Wayne, IN</em></sub></td>
    <td>
      • Built EHR system using <strong>HL7 & FHIR</strong> standards<br/>
      • Enabled real-time clinical data sharing & interoperability<br/>
      • Hemophilia prediction model from <strong>85+ patient records</strong><br/>
      • Enterprise bioinformatics microservices for multi-omics data<br/>
      • Applied OpenAI NLP for medical record summarization
    </td>
  </tr>
</table>
...
| ⭐ | **Purdue Honors Program** — Triple-degree track |
| 🤝 | **NSLS Presidential Member** — Selected for leadership & academic excellence |
...
<table>
  <tr>
    ...
    <td>
      <strong>Preventive Care for Children at Risk of Hemophilia</strong><br/>
      <sub>Researched genetic disorder probabilities using parental health data · Developed predictive algorithms for hereditary risk · Analyzed allelic compositions to model parent–child genetic correlations</sub>
    </td>
  </tr>
  <tr>
    <td align="center">🌱</td>
    <td>
      <strong>Data-Driven Food Waste Recycling Systems</strong><br/>
      <sub>Designed circular waste management pipelines with hospitality partners · Modeled compost conversion for agricultural fertilizer production · Applied analytics to real-world sustainability challenges</sub>
    </td>
  </tr>
</table>
...
|---|---|---|
| 🎯 **President** | Honors Association for Scholarly Excellence @ Purdue | Hackathons, Shark Tank pitch events, inter-campus competitions |
| 🏛️ **Student Senator** | Purdue University Student Government | Reviewed constitutions, voted on funding, policy governance |
| ⚖️ **Allocations Committee** | Purdue Student Government | Reviewed org budgets & Student Activities Fee allocation |
| 📣 **Dean's Ambassador** | Purdue ETCS | Regional outreach, CS workshops, high school campus visits |
| 🎓 **Honors Council Member** | Purdue Honors Program | Represented student feedback, supported program initiatives |
| 🗣️ **Omnibus Event Coordinator** | Purdue Honors Speaker Series | Managed high-profile speaker logistics & student team |
| 🏗️ **Frontend Developer** | Purdue Honors Department | Built & optimized the Honors program website |
...
**Purdue University** · West Lafayette, IN · *Aug 2023 – May 2027*

`B.S. Computer Science` &nbsp;•&nbsp; `B.S. Data Science & Applied Statistics` &nbsp;•&nbsp; `B.S. Mathematics`

*Honors Program · Dean's List · Triple Major*
